...
ENV_EVENT_TRACKING_BACKENDS = AUTH_TOKENS.get("EVENT_TRACKING_BACKENDS", {})
for key, value in ENV_EVENT_TRACKING_BACKENDS.items():
    EVENT_TRACKING_BACKENDS[key] = value
